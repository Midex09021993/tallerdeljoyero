-- Permite guardar partidas a usuarios de ventas autorizados para el taller,
-- no solo a dueno/gerente. La RPC de creación ya usa este mismo criterio.
...
begin
  ...
  loop
    insert into public.cotizacion_detalles (
      ...
      costo_unitario, precio_unitario, total_costo, total_precio, metadata
    )
    values (
      _cotizacion_id,
