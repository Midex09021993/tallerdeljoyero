...
-- Se crea como migración nueva para instalaciones donde las migraciones históricas
-- ya están registradas pero estas funciones no llegaron al schema cache.
...
-- Solicita a PostgREST recargar el schema después de crear las funciones.
