-- Una cotización puede tener varias versiones.
-- El identificador comercial visible sigue siendo numero + version.
-- La unicidad por sede debe contemplar ambas columnas.
...
-- Asegura que una nueva versión conserve el mismo número y reciba
-- una versión incremental dentro de esa cotización.
