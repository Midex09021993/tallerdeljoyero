    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <button type="button" onClick={() => setModoAsistido(true)} className="group rounded-2xl border border-border bg-card p-5 text-left shadow-sm transition-all duration-200 ease-out hover:-translate-y-1 hover:border-primary/40 hover:bg-card hover:shadow-lg hover:shadow-primary/5 active:translate-y-0 active:scale-[0.995]"><div className="mb-5 grid size-10 place-items-center rounded-xl bg-primary/8 text-primary transition-all duration-200 group-hover:scale-105 group-hover:bg-primary/12 group-hover:shadow-sm"><WandSparkles className="size-5 transition-transform duration-200 group-hover:rotate-6 group-hover:scale-110" /></div><p className="font-semibold">Cuéntaselo al asistente</p><p className="mt-1 min-h-10 text-xs leading-5 text-muted-foreground">Escribe lo que pidió el cliente y prepara un borrador.</p><span className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-primary transition-all duration-200 group-hover:gap-2">Abrir <ArrowRight className="size-3.5 transition-transform duration-200 group-hover:translate-x-0.5" /></span></button>
          <button type="button" onClick={() => setBusca("aprobada")} className="group rounded-2xl border border-border bg-card p-5 text-left shadow-sm transition-all duration-200 ease-out hover:-translate-y-1 hover:border-primary/40 hover:bg-card hover:shadow-lg hover:shadow-primary/5 active:translate-y-0 active:scale-[0.995]"><div className="mb-5 grid size-10 place-items-center rounded-xl bg-primary/8 text-primary transition-all duration-200 group-hover:scale-105 group-hover:bg-primary/12 group-hover:shadow-sm"><WalletCards className="size-5 transition-transform duration-200 group-hover:-rotate-3 group-hover:scale-110" /></div><p className="font-semibold">Aprobadas</p><p className="mt-1 min-h-10 text-xs leading-5 text-muted-foreground">{totalAprobadas > 0 ? "Total aprobado: " + money(totalAprobadas) : "Todavía no hay ventas aprobadas."}</p><span className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-primary transition-all duration-200 group-hover:gap-2">Abrir <ArrowRight className="size-3.5 transition-transform duration-200 group-hover:translate-x-0.5" /></span></button>
        </div>
