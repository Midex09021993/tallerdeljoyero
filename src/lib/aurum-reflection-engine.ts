...
export const AURUM_REFLECTION_RIG_PROFILES:Record<string,AurumReflectionRigProfile>={
  productSoft:{
    softbox:source(15.5,10.5,1.62,[3.4,6.2,5.2]),
    strip:source(3.0,12.5,.58,[-4.0,3.8,3.2]),
    front:source(7.5,5.5,.24,[0,3.4,6.2]),
    kicker:source(2.2,8.0,.42,[4.8,4.2,-3.2]),
    edgeLeft:source(1.0,7.0,.20,[-5.0,3.9,1.3]),
    edgeRight:source(1.0,7.0,.18,[5.0,3.9,1.3]),
  },
  studioSoft:{
