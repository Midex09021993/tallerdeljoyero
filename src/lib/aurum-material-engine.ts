...
export const AURUM_GEM_PRESETS:Record<string,AurumGemPreset>={
  ...
  // Exact catalog IDs: never fall back to diamond when the UI requests a
  // specific natural/quality variant.
  diamante_natural:{id:"diamante_natural",familia:"Diamante",variante:"Natural",color:0xfafcff,transmission:.985,ior:2.417,roughness:.010,envMapIntensity:1.90,attenuationColor:0xf9fcff,attenuationDistance:100,dispersion:.035,iridescence:.02,thicknessScale:1,inclusions:false,inclusionDensity:0,inclusionType:"none"},
  diamante_vs:{id:"diamante_vs",familia:"Diamante",variante:"VS",color:0xfcfdff,transmission:.99,ior:2.417,roughness:.008,envMapIntensity:1.98,attenuationColor:0xfbfdff,attenuationDistance:100,dispersion:.035,iridescence:.018,thicknessScale:1,inclusions:false,inclusionDensity:0,inclusionType:"none"},
  rubi_natural:{id:"rubi_natural",familia:"Rubí",variante:"Natural",color:0x9e1020,transmission:.90,ior:1.762,roughness:.020,envMapIntensity:1.65,attenuationColor:0x65070f,attenuationDistance:13,dispersion:.014,iridescence:0,thicknessScale:1.05,inclusions:false,inclusionDensity:0,inclusionType:"none"},
  esmeralda_inclusiones:{id:"esmeralda_inclusiones",familia:"Esmeralda",variante:"Con inclusiones",color:0x075f3e,transmission:.82,ior:1.577,roughness:.030,envMapIntensity:1.50,attenuationColor:0x043e29,attenuationDistance:8,dispersion:.012,iridescence:0,thicknessScale:1.08,inclusions:true,inclusionDensity:.22,inclusionType:"fingerprint"}
};
