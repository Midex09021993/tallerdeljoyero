...
export const GEMAS: GemaConfig[] = [
  ...
  { id:"granate_estrella", familia:"Granate", nombre:"Granate · Estrella Natural", color:0x6d2030, transmission:.78, ior:1.79, roughness:.055, envMapIntensity:3.3, attenuationColor:0x43101e, attenuationDistance:1.5, dispersion:.035, iridescence:.004, inclusionStyle:"silk", inclusionStrength:.26, origen:"Global", perfilInterno:"generico", fenomenoOptico:"asterism", notaGemologica:"Granates pueden mostrar asterismo por inclusiones orientadas; la geometría del fenómeno depende de la especie y orientación cristalográfica." },
  { id:"turmalina_gato", familia:"Turmalina", nombre:"Turmalina · Ojo de Gato", color:0x278d70, transmission:.82, ior:1.634, roughness:.05, envMapIntensity:3.45, attenuationColor:0x175d4a, attenuationDistance:1.8, dispersion:.018, iridescence:.006, inclusionStyle:"silk", inclusionStrength:.25, origen:"Global", perfilInterno:"generico", fenomenoOptico:"chatoyancy", notaGemologica:"La turmalina puede presentar chatoyancia por inclusiones lineales orientadas; el efecto requiere corte cabujón y orientación adecuados." },
