...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xf5f3ef,ground:0xe7e3dc,groundRoughness:.72,groundMetalness:.002,groundVisible:true,environmentIntensity:.78,environmentRotation:.32,shadowIntensity:.10,shadowSoftness:.995,exposure:.82},
