...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xf7f6f3,ground:0xe9e7e3,groundRoughness:.78,groundMetalness:.002,groundVisible:true,environmentIntensity:1.0,environmentRotation:.32,shadowIntensity:.16,shadowSoftness:.985,exposure:.84},
