...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xf4f2ee,ground:0xe5e1da,groundRoughness:.62,groundMetalness:.003,groundVisible:true,environmentIntensity:.68,environmentRotation:.18,shadowIntensity:.12,shadowSoftness:.99,exposure:.76},
