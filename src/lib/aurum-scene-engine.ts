...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xf1f0ed,ground:0xe8e6e1,groundRoughness:.72,groundMetalness:.001,groundVisible:true,environmentIntensity:.98,environmentRotation:.30,shadowIntensity:.26,shadowSoftness:.92,exposure:1.0},
