...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xe7e7e4,ground:0xe3e1dd,groundRoughness:.82,groundMetalness:.001,groundVisible:true,environmentIntensity:.72,environmentRotation:.42,shadowIntensity:.22,shadowSoftness:.985,exposure:.88},
