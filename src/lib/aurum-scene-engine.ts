...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xe7e4de,ground:0xdad6cf,groundRoughness:.52,groundMetalness:.005,groundVisible:true,environmentIntensity:.62,environmentRotation:.12,shadowIntensity:.14,shadowSoftness:.97,exposure:.68},
