...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xf4f3f0,ground:0xe8e6e1,groundRoughness:.46,groundMetalness:.01,groundVisible:true,environmentIntensity:.82,environmentRotation:.12,shadowIntensity:.18,shadowSoftness:.96,exposure:.84},
