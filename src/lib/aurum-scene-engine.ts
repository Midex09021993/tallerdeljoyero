...
export const AURUM_SCENE_PRESETS:Record<string,AurumScenePreset>={
  ...
  producto:{id:"producto",background:0xeeeae4,ground:0xd8d3cc,groundRoughness:.56,groundMetalness:.005,groundVisible:true,environmentIntensity:.50,environmentRotation:.18,shadowIntensity:.18,shadowSoftness:.98,exposure:.62},
